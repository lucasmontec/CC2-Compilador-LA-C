...
public interface LAGrammar1_CodeGenListener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by {@link LAGrammar1_CodeGenParser#mais_selecao}.
	 * @param ctx the parse tree
	 */
	void enterMais_selecao(@NotNull LAGrammar1_CodeGenParser.Mais_selecaoContext ctx);
	/**
	 * Exit a parse tree produced by {@link LAGrammar1_CodeGenParser#mais_selecao}.
	 * @param ctx the parse tree
	 */
	void exitMais_selecao(@NotNull LAGrammar1_CodeGenParser.Mais_selecaoContext ctx);
